(() => {
    ...
    const CUPA2_TOTAL_BET_PAY = { 3: 2, 4: 20, 5: 100 };

    const paytableOrder = ['zeu', 'rega', 'lup', 'vultur', 'a', 'k', 'q', 'cupa', 'cupa2'];
    ...
    /* Fallback = reel-strips.json (mapat din Millionaire Crown). */
    const DEFAULT_MECHANICAL_REEL_STRIPS = [
        ['cupa', 'q', 'rega', 'k', 'vultur', 'zeu', 'k', 'scatter', 'cupa', 'lup', 'a', 'k', 'vultur', 'a', 'scatter', 'zeu', 'rega', 'q', 'a', 'k', 'vultur', 'lup', 'k', 'scatter', 'cupa', 'q', 'a', 'zeu', 'vultur', 'a', 'k', 'scatter', 'cupa', 'q', 'a', 'k', 'vultur', 'a', 'k', 'a', 'cupa', 'q', 'a', 'k', 'vultur', 'a', 'k', 'scatter'],
        ['cupa', 'q', 'rega', 'k', 'vultur', 'a', 'k', 'cupa2', 'cupa', 'lup', 'a', 'k', 'vultur', 'a', 'k', 'zeu', 'rega', 'q', 'a', 'k', 'vultur', 'lup', 'k', 'rega', 'cupa', 'q', 'a', 'k', 'vultur', 'a', 'k', 'lup', 'cupa', 'q', 'a', 'k', 'vultur', 'a', 'k', 'k', 'cupa', 'q', 'a', 'k', 'vultur', 'a', 'k', 'zeu'],
        ['cupa', 'q', 'rega', 'k', 'vultur', 'zeu', 'a', 'cupa2', 'cupa', 'lup', 'a', 'k', 'vultur', 'k', 'a', 'zeu', 'rega', 'q', 'a', 'k', 'vultur', 'lup', 'a', 'rega', 'cupa', 'q', 'a', 'zeu', 'vultur', 'k', 'a', 'lup', 'cupa', 'q', 'a', 'k', 'vultur', 'k', 'a', 'q', 'cupa', 'q', 'a', 'k', 'vultur', 'k', 'a', 'zeu'],
        ['q', 'cupa', 'cupa2', 'zeu', 'rega', 'a', 'vultur', 'a', 'k', 'q', 'cupa', 'cupa2', 'a', 'rega', 'lup', 'vultur', 'a', 'k', 'q', 'cupa', 'a', 'zeu', 'rega', 'lup', 'vultur', 'a', 'k', 'q', 'cupa', 'cupa2', 'zeu', 'rega', 'lup', 'a', 'a', 'k', 'q', 'a', 'cupa', 'cupa2', 'zeu', 'rega', 'lup', 'vultur', 'a', 'k', 'q', 'a', 'a', 'cupa', 'cupa2', 'zeu', 'rega', 'lup', 'vultur', 'a', 'k'],
        ['lup', 'vultur', 'a', 'scatter', 'cupa2', 'cupa', 'scatter', 'zeu', 'rega', 'lup', 'scatter', 'a', 'k', 'cupa2', 'cupa', 'cupa', 'q', 'scatter', 'rega', 'lup', 'vultur', 'a', 'k', 'cupa2', 'scatter', 'cupa', 'q', 'zeu', 'rega']
    ];
    ...
    const PREMIUM_LINE_WIN_SYMBOLS = new Set(['zeu', 'rega', 'lup', 'vultur']);
    const SMALL_LINE_WIN_SYMBOLS = new Set(['cupa', 'q', 'k', 'a']);
    ...
    const fullSizeSymbols = new Set(['scatter', 'zeu', 'rega', 'lup', 'vultur', 'q', 'cupa']);

    const STOP_TIMEOUT_MS = 5000;

    const LEGACY_SPEED_KEY = 'logic_and_zeus_speed';
    ...
    function renderInfoPages() {
        ...
        const lineSymbols = ['zeu', 'rega', 'lup', 'vultur', 'a', 'k', 'q', 'cupa'];
        ...
        const cupa2Notes = Object.keys(CUPA2_TOTAL_BET_PAY)
            .map(Number)
            .sort((a, b) => b - a)
            .map((count) => `${count} pe linie = ${CUPA2_TOTAL_BET_PAY[count]}x pariu total`);

        track.innerHTML = C.compose([
            C.symbolsPage({
                brandTitle: 'Fire Scatter',
                layout: 'rows',
                cardLayout: 'stack',
                ...
                cards: [
                    ...
                    C.renderPayCard({
                        imageSrc: symbolSrc('cupa2'),
                        alt: paytableLabels.cupa2,
                        label: paytableLabels.cupa2,
                        wild: true,
                        symbolScale: paySymbolScale.cupa2 || 1,
                        notesLayout: 'spread',
                        notes: cupa2Notes
                    }),
                    C.renderPayCard({
                        ...
                        symbolScale: 1.08,
                        notesLayout: 'spread',
                        notes: ['Doar pe R1 si R5', 'Pozitia devine Wild', 'Fara plata scatter']
                    })
                ]
            }),
            C.linesPage({
                ...
                rules: [
                    ...
                    'Scatter pe R1 sau R5 devine Wild doar pe pozitia unde apare.',
            ...
            C.miniGamePage({
                title: 'Mini-joc LogicZeusMaze',
                lead: 'Dupa o rotire fara castig, poti incerca recuperarea partiala in labirintul procedural.',
                badgeHtml: C.textBadge('Maze', 'M'),
                paragraphs: [
                    'Primesti un labirint generat procedural si trebuie sa ajungi la iesire.',
                    'Navigheaza prin labirint folosind directiile disponibile pana gasesti iesirea.',
                    'Daca ajungi la iesire, primesti inapoi <strong>50% din pariul rotirii</strong> care a activat mini-jocul.',
                    'Dupa o rotire fara plata, butonul de labirint devine activ si poti deschide mini-jocul.'
                ]
            }),
            C.skillPage({
                gameTitle: 'Fire Scatter',
                lead: 'Fire Scatter nu este un joc de noroc. Rezultatul depinde de deciziile si abilitatile jucatorului.',
                ...
                miniCardTitle: 'Mini-joc LogicZeusMaze',
                miniCardText: 'Recuperarea depinde de abilitatea ta de a naviga labirintul si a ajunge la iesire, nu de hazard.',
    ...
    function loadPreferences() {
        try {
            ...
            state.soundEnabled = localStorage.getItem('logic_and_zeus_mute') !== '1';
            ...
            state.playStopMode = localStorage.getItem('logic_and_zeus_play_stop') === '1';
        } catch (error) {
        }
    }
    ...
    function saveSoundPreference() {
        try {
            localStorage.setItem('logic_and_zeus_mute', state.soundEnabled ? '0' : '1');
        } catch (error) {
        }
    ...
    function savePlayStopPreference() {
        try {
            localStorage.setItem('logic_and_zeus_play_stop', state.playStopMode ? '1' : '0');
        } catch (error) {
        }
    }
    ...
    function applyUniformCellStyle(cell) {
        ...
        const isWildCell = cell.classList.contains('is-wild-expanded-cell')
            || cell.classList.contains('is-wild-source')
            || Boolean(cell.closest('.boss-crown-reel.is-locked-wild-reel'));
        cell.style.setProperty('overflow', isWildCell ? 'visible' : 'hidden', 'important');
    ...
    function applyUniformStyles() {
        $$('.boss-crown-reel').forEach((reel) => {
            if (reel.classList.contains('is-locked-wild-reel')) return;
    ...
    function prepareReelStripSymbols(reelIndex) {
        ...
        const symbols = SCATTER_REEL_INDEXES.has(reelIndex)
            ? base
            : base.filter((symbol) => symbol !== 'scatter');
...
function runStopCountdownPhase(timeoutMs) {
    ...
    function clearHalfBetOffer({ closeQuiz = true } = {}) {
        state.halfBetOffer = { active: false, sessionId: null, gameId: null, betAmount: 0 };
        updateHalfButton();
        if (closeQuiz && window.LogicZeusMaze) {
            LogicZeusMaze.close();
        }
    }
    ...
    function applyScatterWildReels(board) {
        if (!Array.isArray(board)) return board;
        const lineBoard = board.map((column) => column.slice());
        lineBoard.forEach((column, reelIndex) => {
    ...
    function clearScatterWildReels() {
        $$('.boss-crown-reel').forEach((reel) => {
            reel.classList.remove('is-locked-wild-reel', 'is-wild-expanding-reel', 'has-wild-line-win', 'has-expanded-wild');
        });
    ...
    async function revealScatterWildPositions(board) {
        const positions = scatterPositions(board);
        for (const position of positions) {
            const [reelIndexStr, rowStr] = position.split('-');
            const reelIndex = Number(reelIndexStr);
            const row = Number(rowStr);
            const reelNode = $(`.boss-crown-reel[data-reel="${reelIndex}"]`);
            const cell = $(`[data-position="${position}"]`);
            if (!cell) continue;
            reelNode?.classList.add('is-wild-expanding-reel');
            cell.classList.add('is-wild-source');
            setCellSymbol(cell, 'wild');
            await delay(110);
            cell.classList.remove('is-wild-source');
            cell.classList.add('is-wild-expanded-cell');
            reelNode?.classList.remove('is-wild-expanding-reel');
            if (state.roundBoard?.[reelIndex]?.[row] === 'scatter') {
                state.roundBoard[reelIndex][row] = 'wild';
            }
        }
    }
    ...
    function evaluatePayline(board, lineRows) {
        ...
        let payout = 0;
        if (target === 'cupa2') {
            const multiplier = CUPA2_TOTAL_BET_PAY[matched];
    ...
    function evaluateBoard(board) {
        const wins = [];
        let total = 0;
        const lineBoard = applyScatterWildReels(board);

        activePaylines().forEach((lineRows, index) => {
            const lineWin = evaluatePayline(lineBoard, lineRows);
            if (!lineWin) return;
    ...
    async function onAllReelsStopped() {
        ...
        const scatterWildPositions = scatterPositions(board);
        if (scatterWildPositions.length > 0) {
            clearScatterPulses();
            playSampleSound('bong');
            await revealScatterWildPositions(board);
        }
