(() => {
    ...
    const symbolFiles = {
        scatter: 'coroana.webp',
        om: '7.webp',
        faraon: 'pepene.webp',
        scarabeu: 'strugure.webp',
        buburuza: 'clopotel.webp',
        a: 'portocala.webp',
        k: 'pruna.webp',
        q: 'lamaie.webp',
        j: 'cireasa.webp',
    ...
    const paytableOrder = ['om', 'faraon', 'scarabeu', 'buburuza', 'a', 'k', 'q', 'j', 'dollar'];
    ...
    const DEFAULT_MECHANICAL_REEL_STRIPS = [
        ['j', 'q', 'faraon', 'k', 'buburuza', 'om', 'k', 'dollar', 'j', 'scarabeu', 'a', 'k', 'buburuza', 'a', 'k', 'om', 'faraon', 'q', 'a', 'k', 'buburuza', 'scarabeu', 'k', 'faraon', 'j', 'q', 'a', 'om', 'buburuza', 'a', 'k', 'scarabeu', 'j', 'q', 'a', 'k', 'buburuza', 'a', 'k', 'iq_i', 'j', 'q', 'a', 'k', 'buburuza', 'a', 'k', 'om'],
        ['j', 'q', 'faraon', 'k', 'buburuza', 'a', 'k', 'scatter', 'j', 'scarabeu', 'a', 'k', 'buburuza', 'a', 'scatter', 'om', 'faraon', 'q', 'a', 'k', 'buburuza', 'scarabeu', 'k', 'scatter', 'j', 'q', 'a', 'k', 'buburuza', 'a', 'k', 'scatter', 'j', 'q', 'a', 'k', 'buburuza', 'a', 'k', 'iq_q', 'j', 'q', 'a', 'k', 'buburuza', 'a', 'k', 'scatter'],
        ['j', 'q', 'faraon', 'k', 'buburuza', 'om', 'a', 'dollar', 'j', 'scarabeu', 'a', 'k', 'buburuza', 'k', 'a', 'om', 'faraon', 'q', 'a', 'k', 'buburuza', 'scarabeu', 'a', 'faraon', 'j', 'q', 'a', 'om', 'buburuza', 'k', 'a', 'scarabeu', 'j', 'q', 'a', 'k', 'buburuza', 'k', 'a', 'iq_w', 'j', 'q', 'a', 'k', 'buburuza', 'k', 'a', 'om'],
        ['q', 'j', 'dollar', 'om', 'faraon', 'scatter', 'buburuza', 'a', 'k', 'q', 'j', 'dollar', 'scatter', 'faraon', 'scarabeu', 'buburuza', 'a', 'k', 'q', 'j', 'scatter', 'om', 'faraon', 'scarabeu', 'buburuza', 'a', 'k', 'q', 'j', 'dollar', 'om', 'faraon', 'scarabeu', 'scatter', 'a', 'k', 'q', 'iq_i', 'j', 'dollar', 'om', 'faraon', 'scarabeu', 'buburuza', 'a', 'k', 'q', 'scatter', 'iq_i', 'j', 'dollar', 'om', 'faraon', 'scarabeu', 'buburuza', 'a', 'k'],
        ['scarabeu', 'buburuza', 'a', 'k', 'dollar', 'j', 'q', 'om', 'faraon', 'scarabeu', 'buburuza', 'a', 'k', 'dollar', 'j', 'iq_n', 'q', 'om', 'faraon', 'scarabeu', 'buburuza', 'a', 'k', 'dollar', 'j', 'iq_n', 'q', 'om', 'faraon']
    ];
    ...
    const SMALL_LINE_WIN_SYMBOLS = new Set(['j', 'q', 'k', 'a']);
    ...
    const fullSizeSymbols = new Set(['scatter', 'dollar', 'om', 'faraon', 'scarabeu', 'buburuza', 'q', 'j', 'iq_i', 'iq_q', 'iq_w', 'iq_n']);
    ...
    const LEGACY_SPEED_KEY = 'boss_crown_speed';
    ...
    function renderInfoPages() {
        ...
        const dollarNotes = Object.keys(DOLLAR_TOTAL_BET_PAY)
            .map(Number)
            .sort((a, b) => b - a)
            .map((count) => `${count} pe linie = ${DOLLAR_TOTAL_BET_PAY[count]}x pariu total`);

        track.innerHTML = C.compose([
            C.symbolsPage({
                brandTitle: 'Millionaire Crown',
                layout: 'rows',
                cardLayout: 'stack',
                ...
                cards: [
                    ...
                    C.renderPayCard({
                        imageSrc: symbolSrc('dollar'),
                        alt: paytableLabels.dollar,
                        label: paytableLabels.dollar,
                        wild: true,
                        symbolScale: 1.08,
                        notesLayout: 'spread',
                        notes: dollarNotes
            ...
            C.linesPage({
                ...
                rules: [
                    ...
                    'Dolarul plateste multiplicator x pariul total, la fel ca celelalte simboluri.',
            ...
            C.miniGamePage({
                ...
                lead: 'Dupa o rotire fara castig, poti raspunde la o intrebare pentru recuperare partiala.',
                badgeHtml: C.textBadge('Quiz', '?'),
                paragraphs: [
                    'Primesti o intrebare cu variante de raspuns si un timp limitat.',
                    'Daca raspunzi corect la timp, primesti inapoi <strong>50% din pariul rotirii</strong> care a activat quiz-ul.',
                    'Dupa o rotire fara plata, butonul de quiz devine activ si poti deschide mini-jocul.'
                ]
            }),
            C.skillPage({
                gameTitle: 'Millionaire Crown',
                lead: 'Millionaire Crown nu este un joc de noroc. Rezultatul depinde de deciziile si abilitatile jucatorului.',
                ...
                miniCardTitle: 'Quiz Millionaire',
                miniCardText: 'Recuperarea depinde de cunostintele tale si de viteza cu care alegi raspunsul corect, nu de hazard.',
    ...
    function loadPreferences() {
        try {
            ...
            state.soundEnabled = localStorage.getItem('boss_crown_mute') !== '1';
            ...
            state.playStopMode = localStorage.getItem('boss_crown_play_stop') === '1';
        } catch (error) {
        }
    }
    ...
    function saveSoundPreference() {
        try {
            localStorage.setItem('boss_crown_mute', state.soundEnabled ? '0' : '1');
        } catch (error) {
        }
    ...
    function savePlayStopPreference() {
        try {
            localStorage.setItem('boss_crown_play_stop', state.playStopMode ? '1' : '0');
        } catch (error) {
        }
    }
    ...
    function applyUniformCellStyle(cell) {
        ...
        const isScatterCell = Boolean(cell.querySelector('img[data-symbol="scatter"], img[data-symbol="dollar"]'));
        if (isScatterCell) {
    ...
    function applyUniformImageStyle(image) {
        if (!image) return;
        const isScatter = image.dataset.symbol === 'scatter' || image.dataset.symbol === 'dollar';
    ...
    function resolveMissingStopIndexes(sourceBoard = state.roundBoard) {
        for (let reelIndex = 0; reelIndex < 5; reelIndex += 1) {
            ...
            if (current !== null && current !== undefined) {
                const normalized = normalizeStopIndex(reelIndex, current);
                if (columnsMatch(readMechanicalColumn(reelIndex, normalized), column)) {
                    state.roundStopIndexes[reelIndex] = normalized;
                    continue;
                }
            }
    ...
    function reconcileAllRoundStops() {
        ...
        if (visibleBoard) {
            state.roundBoard = visibleBoard.map((column) => column.slice());
        }
        resolveMissingStopIndexes(state.roundBoard);
    }
    ...
    function hasCompleteRoundStops() {
        const board = readBoardFromVisibleCells() || state.roundBoard;
        if (!board) {
            return false;
        }
        return board.every((column) => (
            Array.isArray(column) && column.length === 3 && column.every((symbol) => Boolean(symbol))
        ));
    }
    ...
    function readSettledColumnFromStrip(reelNode, reelIndex) {
        ...
        if (strip.dataset.resolvedStopIndex !== undefined && strip.dataset.resolvedStopIndex !== '') {
            ...
            stopIndex = normalizeStopIndex(reelIndex, Math.floor(offset / rowHeight));
        }

        const column = [0, 1, 2].map((row) => {
            const child = strip.children[stopIndex + row];
    ...
    function settleReelToNearestRow(reelNode, profile = 'manual') {
        ...
        return (async () => {
            ...
            const resolvedStopIndex = normalizeStopIndex(reelIndex, Math.floor(to / rowHeight));

            const applySettledPosition = () => {
                strip.style.transform = `translate3d(0, ${-to}px, 0)`;
                if (resolvedStopIndex !== null) {
                    strip.dataset.resolvedStopIndex = String(resolvedStopIndex);
                }
            };
...
function runStopCountdownPhase(timeoutMs) {
    ...
    function clearHalfBetOffer({ closeQuiz = true } = {}) {
        state.halfBetOffer = { active: false, sessionId: null, gameId: null, betAmount: 0 };
        updateHalfButton();
        if (closeQuiz && window.MillionaireQuiz) {
            MillionaireQuiz.close();
        }
    }
    ...
    function countPaylineMatches(symbols) {
        ...
        for (const symbol of symbols) {
            ...
            const normalized = normalizeMatchSymbol(symbol);
            if (target === null) {
                target = normalized;
    ...
    function normalizeMatchSymbol(symbol) {
        return symbol;
    }

    function symbolsMatch(left, right) {
        return normalizeMatchSymbol(left) === normalizeMatchSymbol(right);
    }
    ...
    function evaluatePayline(board, lineRows) {
        ...
        let payout = 0;
        if (target === 'dollar') {
            const multiplier = DOLLAR_TOTAL_BET_PAY[matched];
    ...
    function animateIqwinLetter(cell, symbol, chainBoost = false) {
        ...
        requestAnimationFrame(() => {
            ...
            cell.classList.remove('is-iqwin-pulse');
            void cell.offsetWidth;
            cell.classList.add('is-iqwin-pulse');
        });

        const pulse = () => {
            if (!cell.isConnected || !cell.classList.contains('is-iqwin-reveal')) return;
            cell.classList.remove('is-iqwin-pulse');
            void cell.offsetWidth;
            cell.classList.add('is-iqwin-pulse');
            state.iqwinPulseTimers.push(window.setTimeout(pulse, chainBoost ? 1900 : 2400));
        };
        state.iqwinPulseTimers.push(window.setTimeout(pulse, chainBoost ? 1350 : 1550));
    }
    ...
    function clearScatterPulses() {
        ...
        $$('.boss-crown-cell img[data-symbol="scatter"], .boss-crown-cell img[data-symbol="dollar"]').forEach((image) => {
    ...
    async function revealReel(reelIndex, fromAuto = false) {
        ...
        try {
            ...
            await settleReelToNearestRow(reelNode, fromAuto ? 'auto' : 'manual');
            ...
            if (resolvedStopIndex !== null) {
                state.roundStopIndexes[reelIndex] = normalizeStopIndex(reelIndex, resolvedStopIndex);
            }
            if (!state.roundBoard) state.roundBoard = createEmptyRoundBoard();
            state.roundBoard[reelIndex] = column ? column.slice() : null;
    ...
    async function finishRound(result) {
        ...
        } else if (forfeitWin && result.total > 0) {
            void playWinCycle(result.wins);
        }
    }
    ...
    async function onAllReelsStopped() {
        ...
        const board = (readBoardFromVisibleCells() || state.roundBoard).map((column) => column.slice());
    ...
    function handleHalfButtonClick() {
        ...
        if (window.MillionaireQuiz) {
            MillionaireQuiz.open();
        }
    }
